...
const Container = styled.div`
  ...
  border-radius: 4px;
  animation: ${animations.fadeInBottom} 0.4s cubic-bezier(0.25, 0.1, 0.25, 1),
    ${animations.fadeOutBottom} 0.5s cubic-bezier(0.25, 0.1, 0.25, 1) 3.6s;
  cursor: pointer;
